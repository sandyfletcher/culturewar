...
export default class HeatherSpuckler {
    constructor(game, playerId) {
        ...
        this.personality = {
            ...
            aggressiveness: 1,     // 0.0 to 1.0 (higher means more likely to attack)
            expansion: 0.4,          // 0.0 to 1.0 (higher means more likely to prioritize neutral planets)
            consolidation: 0.3,      // 0.0 to 1.0 (higher means more likely to reinforce owned planets)
            riskTolerance: 1,      // 0.0 to 1.0 (higher means willing to send more troops)
            neighborAwareness: 0.3   // 0.0 to 1.0 (higher means more strategic about neighbor threats)
        };
    }
