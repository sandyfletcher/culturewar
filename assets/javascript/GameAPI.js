...
export default class GameAPI {
    constructor(game, playerId) {
        ...
        this.troopMovementSpeed = 150; // pixels per second, matches PlanetAndTroops.js
    }
     ...
     * Factors in size, production, and centrality.
     * @param {Planet} planet
     ...
     * Factors in nearby enemy troops and incoming attacks.
